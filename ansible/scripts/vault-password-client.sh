...
case "$VAULT_ID" in
    ssh-config)
        op read --account "family-keig.1password.com" "op://Private/Ansible Vault Encryption SSH Config/password"
        ;;
    espanso)
        op read --account "family-keig.1password.com" "op://Private/Ansible Vault Encryption Espanso/password"
        ;;
    *)
